        ...
        <>
            ...
            <div className=" p-3 md:mycontainer min-h-[88.2vh] ">
                <h1 className='text-4xl text font-bold text-center'>
                    ...
                    <span className='text-white'>Pass</span><span className='text-purple-500'>OP/&gt;</span>

                </h1>
                <p className='text-purple-500 text-lg text-center'>Your own Password Manager</p>
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <button onClick={savePassword} className='flex justify-center items-center gap-2 bg-purple-500 hover:bg-purple-300 rounded-full px-8 py-2 w-fit border border-purple-900'>
                        <lord-icon
                ...
                <div className="passwords">
                    <h2 className='font-bold text-white text-2xl py-4'>Your Passwords</h2>
